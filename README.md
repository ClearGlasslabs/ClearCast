...
- Executable, dependency-free governance reference (`artemis_core/`) covering ABAC, approval-gated workflows, hash-chained audit events, eval metrics, artifact promotion, and rollback
